...
export default function HomePage() {
  return (
    <>
      {/* ═══════ HERO ═══════ */}
      <section id="home" className="relative min-h-[100svh] overflow-hidden flex items-center px-[clamp(20px,5vw,80px)] pt-28 pb-20" aria-label="Accueil">
        <HeroCanvas />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h1 className="font-display text-[clamp(44px,7vw,96px)] font-bold leading-[.92] tracking-[-.02em] text-white mb-6">
                <span className="block animate-fadeUp" style={{ animationDelay: '.08s', opacity: 0 }}>Foire</span>
                <span className="block text-gold-2 animate-fadeUp" style={{ animationDelay: '.18s', opacity: 0 }}>Économique</span>
                <span className="block animate-fadeUp" style={{ animationDelay: '.28s', opacity: 0 }}>Ouest-Africaine</span>
              </h1>
